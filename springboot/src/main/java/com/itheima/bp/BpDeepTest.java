...
public class BpDeepTest {
     ...
     * @return
     */
    public static String getQuality(double[] x){
        loadData("E:\\PM2.5预测系统资料\\Back-Propagation-Neural-Network-master\\AirQualityUCI.data");//载入训练数据
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        for (int s = 0; s < 100; s++) {//循环训练10000次
        ...
        return Show_air_quality(result);
    }
